...
* Banco de dados e SQL (modelagem e operações CRUD)
...
Projetos desenvolvidos durante o CodeRDIversity, aplicando conceitos de orientação a objetos, APIs, banco de dados e testes unitários.
🛠️ C# | .NET | SQL
